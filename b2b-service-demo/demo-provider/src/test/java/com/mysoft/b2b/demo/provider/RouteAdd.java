...
public class RouteAdd {
    ...
    public void start() {
        ...
        URL routeUrl = URL.valueOf("condition://" + NetUtils.getLocalHost() + "/" + UserService.class.getName() + "?category=routers&dynamic=false&rule=" + URL.encode("host=" + NetUtils.getLocalHost() + " => host=" + NetUtils.getLocalHost()));
